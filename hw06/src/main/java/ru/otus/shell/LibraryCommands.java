...
public class LibraryCommands {
    ...
    public void getBook(int bookId) {
        System.out.println(bookRepo.findById(bookId));
    }
    ...
    public void addBook(@ShellOption Integer bookId, @ShellOption String bookName,
        ...
        Book book = bookRepo.save(new Book(bookId, bookName, authors, new Genre(0, genre)));
    ...
    public void addBookComment(@ShellOption Integer commentId, @ShellOption Integer bookId,
        ...
        if (book.isPresent()) {
            Comment comment = bookRepo.addComment(new Comment(commentId, book.get(), userName, text));
    ...
    public void getAllBookComments(@ShellOption Integer bookId) {
        bookRepo.findAllCommentsByBookId(bookId).forEach(System.out::println);
    }
